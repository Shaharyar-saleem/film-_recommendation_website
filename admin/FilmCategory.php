                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title mb-3">Film Related Categories</h4>
                            <div>
                                <div class="table-responsive">
                                    <div class="table-wrapper">
                                        <div class="table-title">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <h2>Manage <b>Film</b> Categories</h2>
                                                </div>
                                                <div class="col-sm-6">
                                                    <a href="#addFilmModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Film Category</span></a>
                                                </div>
                                            </div>
                                        </div>
                                        <table class="table table-striped table-hover">
                                            ...
                                            while ($row = pg_fetch_object($result)){
                                                ...
                                                echo '<tr>';
                                                echo '<td>';
                                                echo  $category_result[0];
                                                echo '</td>';
                                                echo '<td>';
                                                echo  $category_result[1];
                                                echo '</td>';
                                                echo '<td>';
                                                echo '<div class="d-flex">';
                                                echo '<a href="editFilmCategory.php/?id='.$category_result[0].'" class="btn btn-success btn-sm mr-2 color-white">Edit</a>';
                                                echo  '<form action="adminDashboard.php" method="POST">
                                                                   <input type="hidden" name="adminAction" value="deleteFilmCategory">
                                                                   <input type="hidden" name="category_id" value='.$category_result[0].'>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="adminDashboard.php" method="POST">
                                            <input type="hidden" name="adminAction" value="addFilmCategory">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Add Film Category</h4>
